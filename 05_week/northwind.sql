...
CREATE TABLE public.categories (
    ...
    categoryname character varying(40),
    description text,
    picture text
);
...
CREATE TABLE public.employees (
    ...
    titleofcourtesy character varying(50),
    birthdate date,
    hiredate date,
    address character varying(100),
    city character varying(50),
...
--
-- Name: hiring_age; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.hiring_age AS
 SELECT e.employeeid,
    (((e.firstname)::text || ' '::text) || (e.lastname)::text) AS employee_name,
    e.hiredate,
    e.birthdate,
    (EXTRACT(YEAR FROM e.hiredate) - EXTRACT(YEAR FROM e.birthdate)) AS hiring_age
...
--
-- Name: employee_territories employee_territories_employeeid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.employee_territories
    ADD CONSTRAINT employee_territories_employeeid_fkey FOREIGN KEY (employeeid) REFERENCES public.employees(employeeid) ON DELETE CASCADE;


--
-- Name: employee_territories employee_territories_territoryid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.employee_territories
    ADD CONSTRAINT employee_territories_territoryid_fkey FOREIGN KEY (territoryid) REFERENCES public.territories(territoryid) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.order_details
    ADD CONSTRAINT order_details_orderid_fkey FOREIGN KEY (orderid) REFERENCES public.orders(orderid) ON DELETE CASCADE;
...
--
-- Name: orders orders_customerid_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_customerid_fkey1 FOREIGN KEY (customerid) REFERENCES public.customers(customerid) ON DELETE CASCADE;
...
--
-- Name: orders orders_employeeid_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_employeeid_fkey1 FOREIGN KEY (employeeid) REFERENCES public.employees(employeeid) ON DELETE CASCADE;


--
-- Name: orders orders_shipvia_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_shipvia_fkey FOREIGN KEY (shipvia) REFERENCES public.shippers(shipperid) ON DELETE CASCADE;


--
-- Name: orders orders_shipvia_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_shipvia_fkey1 FOREIGN KEY (shipvia) REFERENCES public.shippers(shipperid) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.territories
    ADD CONSTRAINT territories_regionid_fkey FOREIGN KEY (regionid) REFERENCES public.regions(regionid) ON DELETE CASCADE;


--
-- Name: territories territories_regionid_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.territories
    ADD CONSTRAINT territories_regionid_fkey1 FOREIGN KEY (regionid) REFERENCES public.regions(regionid) ON DELETE CASCADE;
