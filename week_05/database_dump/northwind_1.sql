...
CREATE TABLE public.regions (
    ...
    regiondescription character varying(9)
);
...
CREATE TABLE public.territories (
    ...
    territorydescription character varying(20) NOT NULL,
    regionid integer
);
...
--
-- Name: employees employees_reportsto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employees
    ADD CONSTRAINT employees_reportsto_fkey FOREIGN KEY (reportsto) REFERENCES public.employees(employeeid) ON DELETE CASCADE;
